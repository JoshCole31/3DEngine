...
int main(int argc, char** argv)
{
	...
	//	component->model = engine->Get<jc::ResourceSystem>()->Get<jc::Model>("models/cube.obj");
	//	component->material = engine->Get<jc::ResourceSystem>()->Get<jc::Material>("material/wood.mtl", engine.get());
