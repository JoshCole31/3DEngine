...
bool jc::json::Load(const std::string& filename, rapidjson::Document& document)
{
	bool success = false;
...
bool jc::json::Get(const rapidjson::Value& value, const std::string& name, int& data)
{
...
bool jc::json::Get(const rapidjson::Value& value, const std::string& name, float& data)
{
...
bool jc::json::Get(const rapidjson::Value& value, const std::string& name, bool& data)
{
...
bool jc::json::Get(const rapidjson::Value& value, const std::string& name, std::string& data)
{
...
bool jc::json::Get(const rapidjson::Value& value, const std::string& name, glm::vec2& data)
{
...
bool jc::json::Get(const rapidjson::Value& value, const std::string& name, glm::vec3& data)
{
	// check if 'name' member exists and is an array with 2 elements
...
bool jc::json::Get(const rapidjson::Value& value, const std::string& name, glm::vec4& data)
{
...
bool jc::json::Get(const rapidjson::Value& value, const std::string& name, std::vector<std::string>& data)
{
...
bool jc::json::Get(const rapidjson::Value& value, const std::string& name, std::vector<int>& data)
{
